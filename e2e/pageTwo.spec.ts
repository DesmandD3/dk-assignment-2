...
let urlPageTwo = "http://localhost:3000/two";
...
test.describe('Main area', () => {
    test('Header H1 Tag', async({ page }) => {
        ...
        await expect(page.locator('h1')).toContainText('My Top Picks');
    })
    ...
    test('Count number of headers in top area', async({ page }) => {
        await page.goto(urlPageTwo)
